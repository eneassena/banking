...
func (d *AccountRepositoryDb) SaveTransaction(t Transaction) (*Transaction, *errs.ApiError) {
...
func (d AccountRepositoryDb) FindBy(accountId string) (*Account, *errs.ApiError) {
